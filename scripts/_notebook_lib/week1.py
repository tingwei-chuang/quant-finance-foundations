        ...
        *quiz_cells(
            ...
            items=[
                (
                    ...
                    ["wᵀΣw", "wᵀμ", "Σw", "wwᵀ"],
                    "A",
                    "權重向量 w 與共變異數矩陣 Σ 的 quadratic form 即為投組變異數。",
                ),
                (
                    "共變異數矩陣必須是 PSD，原因是？",
                    [
                        "它是對稱矩陣",
                        "任何投組的變異數 wᵀΣw 都不可能為負",
                        "特徵值必須為整數",
                        "為了數值穩定",
                    ],
                    "B",
                    "若存在負特徵值，就能構造出變異數為負的投組——這在數學上不可能。",
                ),
                (
                    "log return 相對 simple return 的關鍵性質是？",
                    ["永遠較大", "跨期可加", "不受價格影響", "永遠為正"],
                    "B",
                    "多期 log return 是各期之和；simple return 是相乘關係，不可直接相加。",
                ),
                (
                    "把日波動度年化要乘上？",
                    ["252", "√252", "12", "√12"],
                    "B",
                    "在 i.i.d. 假設下變異數隨期間線性放大，所以標準差乘 √252。",
                ),
            ],
        ),
        mistakes(
